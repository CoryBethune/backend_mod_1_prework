...
d = "#{name} must not return to Hogwarts!"
p d
...
# I used a number for the number of pets because it's in the variable name.
# I used a string for my name because that's a word.
# I used a boolean instead of a string because I wanted to use all different data types.
